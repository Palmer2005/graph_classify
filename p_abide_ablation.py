...
def parse_args():
    parser = argparse.ArgumentParser(description='ABIDE Graph Classification — Ablation M0~M3')
    ...
    parser.add_argument('--save_path', type=str, default='./model_abide_ablation/')
...
def main():
    ...
    ch.setFormatter(fmt)
    fh = logging.FileHandler('abide_ablation_10runs_stats.log', encoding='utf-8')
