...
def parse_args():
    parser = argparse.ArgumentParser(description='DS000030 Graph Classification — Ablation M0~M3')
    ...
    parser.add_argument('--save_path', type=str, default='./model_ds30_ablation/')
...
def main():
    ...
    ch.setFormatter(fmt)
    fh = logging.FileHandler('ds30_ablation_10runs_stats.log', encoding='utf-8')
