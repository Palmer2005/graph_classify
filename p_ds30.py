...
from imports.DS000030Dataset import DS000030Dataset
...
def parse_args():
    parser = argparse.ArgumentParser(description='DS000030 Graph Classification — 10 Random Runs')
    parser.add_argument('--epoch', type=int, default=0)
    parser.add_argument('--n_epochs', type=int, default=50)
    parser.add_argument('--batchSize', type=int, default=189)   # DS000030: 189 ROI
    parser.add_argument('--dataroot', type=str,
                        default='/share/home/u24666550/graph_classify/fmri_1d_gnn_nozero')
    ...
    parser.add_argument('--indim', type=int, default=189)       # DS000030: 189 ROI
    parser.add_argument('--nroi', type=int, default=189)
    parser.add_argument('--nclass', type=int, default=2)
    parser.add_argument('--load_model', type=bool, default=False)
    parser.add_argument('--save_model', type=bool, default=True)
    parser.add_argument('--optim', type=str, default='Adam')
    parser.add_argument('--save_path', type=str, default='./model_ds30_randomsplit/')
...
def main():
    ...
    ch.setFormatter(fmt)
    fh = logging.FileHandler('ds30_randomsplit_10runs_stats.log', encoding='utf-8')
    ...
    path = opt.dataroot
    name = 'DS000030'
    dataset = DS000030Dataset(path, name)
