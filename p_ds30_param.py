...
def parse_args():
    parser = argparse.ArgumentParser(description='DS000030 Parameter Sensitivity Validation')
    parser.add_argument('--dataroot', type=str,
                        default='/share/home/u24666550/graph_classify/fmri_1d_gnn_nozero')
    parser.add_argument('--indim', type=int, default=189)
    parser.add_argument('--nroi', type=int, default=189)
    parser.add_argument('--nclass', type=int, default=2)
    parser.add_argument('--batchSize', type=int, default=189)
...
def main():
    ...
    ch.setFormatter(fmt)
    fh = logging.FileHandler('ds30_param_search.log', encoding='utf-8')
    ...
    logger.info("\n" + "=" * 60)
    logger.info("DS000030 Parameter Sensitivity — M3 (gcn_gater_pool_reg)")
